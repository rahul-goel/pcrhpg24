...
#include "cudaGL.h"
#include "experimental/kernel_data.h"

using namespace std;
using namespace std::chrono_literals;
using nlohmann::json;

struct Experimental : public Method {
	...
	Experimental(Renderer* renderer, shared_ptr<ComputeLasData> las){

		this->name = "experimental";
    this->description = "experimental";
		this->las = las;
		...
		resolveProg = new CudaProgram("./modules/experimental/resolve.cu");
		renderProg = new CudaProgram("./modules/experimental/render.cu");
